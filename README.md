...
- 🎯 **연령대별 타겟 마케팅 전략 수립을 위한 인사이트 도출**  
  고객 연령 정보를 기반으로 타겟층을 세분화하고, 마케팅 전략 수립에 필요한 데이터 기반 분석을 지원합니다.

- 🧭 **회원 등급 및 지역 기반 미디어 채널 운영 전략 강화**  
  회원 등급과 지역별 특성을 분석하여, 효율적인 채널 운영과 지역 맞춤 전략 수립에 활용됩니다.

- 🚀 **디지털 미이용 고객군 발굴 및 전환 촉진 방안 마련**  
  미이용 고객 식별을 위한 채널 접근 이력 분석을 통해, 디지털 전환 유도 정책 수립에 기여합니다.
...
- 미디어 채널의 이용자가 대다수 여성인것을 토대로 이벤트 광고 및 타겟층을 **여성**으로 잡을 수 있다는것을 알 수 있습니다.
...
## ✅ 결론
- **디지털 채널 가입률은 65.05%로** 높지만, 실제 사용률은 36.94%로 낮았습니다.  
  → **가입 이후의 사용 지속성 확보 전략**이 필요합니다.

- **여성 고객의 가입률이 상대적으로 높게 나타났으며**,  
  이를 바탕으로 **이벤트 광고 및 타겟 마케팅을 여성 중심으로 설계**할 수 있습니다.

- **고객 등급이 높을수록 디지털 채널 이용률이 높았으며**,  
  → **등급이 낮은 고객의 유입을 유도하는 별도의 전략**이 필요합니다.

- **30~40대 연령층에서 디지털 채널 이용이 활발했으며**,  
  **45~50대에서는 낮은 이용률**을 보였습니다.  
  → **비고객층 대상 캠페인 및 UX 개선을 통한 접근 필요성**이 제기됩니다.

- **소비 유형에 따라 디지털 채널의 효용 인식이 달라졌으며**,  
  → **소비 목적에 맞춘 콘텐츠 및 채널 전략 설계**를 통해 고객 구매 유도할 수 있을 것입니다.
<br/>
